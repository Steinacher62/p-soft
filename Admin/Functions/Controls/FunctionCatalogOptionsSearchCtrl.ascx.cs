...
{
    public partial class FunctionCatalogOptionsSearchCtrl : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            LanguageMapper _map = LanguageMapper.getLanguageMapper(Session);
            LabelTitle.Text = _map.get("functionRating", "catalogOption");
            LabelName.Text = _map.get("functionRating", "title");
        }
    }
}