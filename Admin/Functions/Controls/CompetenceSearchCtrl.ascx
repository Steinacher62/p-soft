<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CompetenceSearchCtrl.ascx.cs" Inherits="ch.appl.psoft.Admin.Functions.Controls.CompetenceSearchCtrl" %>
<div class="CommandRow">
    <div style="display: table-cell;" class="CommandCell">
        <telerik:RadImageButton ID="SeachImageButton" runat="server" Image-Url="../../Images/search_enable.gif" Height="20px" AutoPostBack="false" OnClientClicked="CompetenceSearchClick"></telerik:RadImageButton>
    </div>
</div>
<div style="height: 100%; width: 100%">
    <div style="display: table; width: 100%;" class="SearchTable">
        ...
        <div style="display: table-row;">
            ...
            <div style="display: table-cell;" class="searchData">
                <telerik:RadTextBox ID="TBNameShort" runat="server" CssClass="Textbox"></telerik:RadTextBox>
            </div>
        </div>
    </div>
</div>
