<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FunctionCatalogOptionsSearchCtrl.ascx.cs" Inherits="ch.appl.psoft.Admin.Functions.Controls.FunctionCatalogOptionsSearchCtrl" %>
<div class="CommandRow">
    <div style="display: table-cell;" class="CommandCell">
        <telerik:RadImageButton ID="SeachImageButton" runat="server" Image-Url="../../Images/search_enable.gif" Height="20px" AutoPostBack="false" OnClientClicked="FunctionCatalogOptionsSearchClick"></telerik:RadImageButton>
    </div>
</div>
