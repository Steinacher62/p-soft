<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FunctionSearchCtrl.ascx.cs" Inherits="ch.appl.psoft.Admin.Functions.Controls.FunctionSearchCtrl" %>
<div class="CommandRow">
    <div style="display: table-cell;" class="CommandCell">
        <telerik:RadImageButton ID="SeachImageButton" runat="server" Image-Url="../../Images/search_enable.gif" Height="20px" AutoPostBack="false" OnClientClicked="FunctionSearchClick"></telerik:RadImageButton>
    </div>
</div>
