<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DutySearchCtrl.ascx.cs" Inherits="ch.appl.psoft.Admin.Functions.Controls.DutySearchCtrl" %>
<div class="CommandRow">
    <div style="display: table-cell;" class="CommandCell">
        <telerik:RadImageButton ID="SeachImageButton" runat="server" Image-Url="../../Images/search_enable.gif" Height="20px" AutoPostBack="false" OnClientClicked="DutySearchClick"></telerik:RadImageButton>
    </div>
</div>
