...
{
    public partial class FunctionGroupDetailCtrl : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            LanguageMapper _map = LanguageMapper.getLanguageMapper(Session);
            LabelTitle.Text = _map.get("function", "group");
            LabelGroupParent.Text = _map.get("function", "parent");
            LabelGroup.Text = _map.get("function", "name");
