...
{
    public partial class KnowledgeMenu : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            LanguageMapper _map = LanguageMapper.getLanguageMapper(Session);
            LMRORU_Layout.MainTitle = _map.get("orgMenu", "knowledgeMenu");
            LMRORU_Layout.pageViewL.Controls.Add((KnowledgeMenuTreeCtrl)LoadControl("Controls/KnowledgeMenuTreeCtrl.ascx"));
