...
{
    public partial class OrganisationMenuTreeCtrl : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            long rootId = (long)db.lookup("ID", "MENUGROUP", "MNEMO = 'ORGANISATION' AND PARENT_ID IS NULL");
