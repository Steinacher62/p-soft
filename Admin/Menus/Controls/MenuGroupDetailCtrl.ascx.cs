...
{
    public partial class MenuGroupDetailCtrl : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            LanguageMapper _map = LanguageMapper.getLanguageMapper(Session);
            LabelTitle.Text = _map.get("MENUGROUP", "GROUP");
            LabelGroupName.Text = _map.get("MENUGROUP", "TITLE");
            LabelShortName.Text = _map.get("MENUGROUP", "MNEMO");
        }
    }
}