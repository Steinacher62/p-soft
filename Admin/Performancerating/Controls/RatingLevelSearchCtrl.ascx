<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RatingLevelSearchCtrl.ascx.cs" Inherits="ch.appl.psoft.Admin.Performancerating.Controls.RatingLevelSearchCtrl" %>
<div class="CommandRow">
    <div style="display: table-cell;" class="CommandCell">
        <telerik:RadImageButton ID="SeachImageButton" runat="server" Image-Url="../../Images/search_enable.gif" Height="20px" AutoPostBack="false" OnClientClicked="RatingLevelSearchClick"></telerik:RadImageButton>
    </div>
</div>
