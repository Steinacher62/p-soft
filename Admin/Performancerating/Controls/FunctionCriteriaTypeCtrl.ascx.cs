...
{
    public partial class FunctionCriteriaTypeCtrl : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            LanguageMapper _map = LanguageMapper.getLanguageMapper(Session);
            FunctionCriteriaTyp.Text = _map.get("performanceRating", "takeWeightingFromFunctionrating");
        }
    }
}