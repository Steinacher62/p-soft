<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CriteriaSearchCtrl.ascx.cs" Inherits="ch.appl.psoft.Admin.Performancerating.Controls.CriteriaSearchCtrl" %>
