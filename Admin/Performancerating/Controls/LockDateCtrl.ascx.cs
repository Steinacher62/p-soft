...
{
    public partial class LockDateCtrl : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            LanguageMapper _map = LanguageMapper.getLanguageMapper(Session);
            detailTitle.Text = _map.get("performanceRating", "lockdate");
            lockDateLabel.Text = _map.get("performanceRating", "date");
        }
    }
}