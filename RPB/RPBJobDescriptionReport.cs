...
namespace ch.appl.psoft.RPB
{
    ...
    /// </summary>
    public class RPBJobDescriptionReport : PsoftPDFReport
	{
        ...
        public RPBJobDescriptionReport(HttpSessionState session, string imageDirectory)
            : base(session, imageDirectory)
        {
            ...
            node.Attributes.Append(createAttribute("border-width-bottom", "0"));
        ...
        public void createReport(int jobID)
        {
            ...
            spzWriteHeaderAndFooter(_map.get("RPB", "Title"), _reportDate);
            ...
            _nCell.InnerText = _map.get("RPB", "JobDescription");
            ...
            _nCell.InnerText = _map.get("RPB", "JobOwner");
            ...
            _nCell = _nRow.AppendChild(createCell());
            _nCell.Attributes.Append(createClassAttribute("detailName"));
            _nCell.InnerText = _map.get("RPB", "Function");
            ...
            //_nCell = _nRow.AppendChild(createCell());
            //_nCell.Attributes.Append(createClassAttribute("detailName"));
            //_nCell.InnerText = _map.get("RPB", "externDescription");
			...
			_nCell = _nRow.AppendChild(createCell());
			_nCell.Attributes.Append(createClassAttribute("detailName"));
			_nCell.InnerText = _map.get("RPB", "Engagement");
            ...
            //_nCell = _nRow.AppendChild(createCell());
            //_nCell.Attributes.Append(createClassAttribute("detailName"));
            //_nCell.InnerText = "Platzhalter";

            //_nCell = _nRow.AppendChild(createCell());
            //_nCell.Attributes.Append(createClassAttribute("detailValue"));
            //_nCell.InnerText = "1234567890";
            ...
            _nCell = _nRow.AppendChild(createCell());
            _nCell.Attributes.Append(createClassAttribute("detailName"));
            _nCell.InnerText = _map.get("RPB", "OE");
			...
			_nCell = _nRow.AppendChild(createCell());
			_nCell.Attributes.Append(createClassAttribute("detailName"));
			_nCell.InnerText = _map.get("RPB", "LeaderFunction");
			...
			_nCell = _nRow.AppendChild(createCell());
			_nCell.Attributes.Append(createClassAttribute("detailName"));
			_nCell.InnerText = _map.get("RPB", "substituted");
			...
			_nCell = _nRow.AppendChild(createCell());
			_nCell.Attributes.Append(createClassAttribute("detailName"));
			_nCell.InnerText = _map.get("RPB", "substitutes");
            ...
            _nTable = AppendDutyTable();
            //_nTable.Attributes.Append(createAttribute("border-width-outer", ".5"));
            _nTable.Attributes.Append(createAttribute("border-width-outer", "0"));
            _nRow = _nTable.AppendChild(createRow());
            _nRow.Attributes.Append(createClassAttribute("spzTitle"));
            _nCell = _nRow.AppendChild(createCell());
            _nCell.Attributes.Append(createAttribute("colspan", "2"));
            _nCell.InnerText = "1. " + _map.get("RPB", "Overview");
			...
			for(int i = 0; i < duties.Rows.Count; i++) 
			{
				...
				if(ch.psoft.db.SQLColumn.GetValid(duties.Rows[i][3],0)==0) 
				{
					...
					_nTable = AppendDutyTable();
                    _nTable.Attributes["padding-all"].Value = "0";
                    //_nTable.Attributes.Append(createAttribute("padding-top", "2"));
                    //_nTable.Attributes.Append(createAttribute("padding-bottom", "2"));
					//_nTable.Attributes.Append(createAttribute("border-width-outer", ".5"));
                    _nTable.Attributes.Append(createAttribute("border-width-outer", "0"));

                    // soll ein Abschnitt nur ausgegeben werden wenn er ganz auf eine Seite passt?
					_nTable.Attributes.Append(createAttribute("keep-together", "false"));
                    _nTable.Attributes.Append(createAttribute("border-after-width.conditionally", "retain"));
                    _nTable.Attributes.Append(createAttribute("border-before-width.conditionally", "retain"));

                    // Header
                    XmlNode _nHeader = _nTable.AppendChild(createHeader());
                    _nRow = _nHeader.AppendChild(createRow());
					//_nRow = _nTable.AppendChild(createRow());

                    _nRow.Attributes.Append(createClassAttribute("spzTitle"));
                    _nRow.Attributes.Append(createAttribute("padding-top", "2"));
                    _nRow.Attributes.Append(createAttribute("padding-bottom", "2"));
					_nCell = _nRow.AppendChild(createCell());
					_nCell.Attributes.Append(createAttribute("colspan", "2"));
                    ...
                    // leere Zelle
                    _nRow = _nTable.AppendChild(createRow());
                    //_nRow.Attributes.Append(createAttribute("height", "0pt"));
                    _nRow.Attributes.Append(createClassAttribute("spzTitle"));
                    _nCell = _nRow.AppendChild(createCell());
                    _nCell.Attributes.Append(createAttribute("colspan", "2"));
                    _nCell.Attributes.Append(createAttribute("height", "0pt"));
                    _nCell.Attributes.Append(createAttribute("padding", "0pt"));
                    _nCell.Attributes.Append(createAttribute("fill-color", "#fbf5ad"));
				} 
				else 
				{
					_nRow = _nTable.AppendChild(createRow());
					_nCell = _nRow.AppendChild(createCell());
					_nCell.Attributes.Append(createAttribute("colspan", "2"));
                    _nCell.Attributes.Append(createAttribute("padding-left", "5pt"));

                    //_nRow.Attributes.Append(createAttribute("border-left-width", "0pt"));

					_nCell.Attributes.Append(createClassAttribute("detailValue"));
                    //_nCell.Attributes.Append(createAttribute("inline-progression-dimension", "10pt"));
			...
			_nCell = _nRow.AppendChild(createCell());
			_nCell.Attributes.Append(createAttribute("colspan", "2"));
			_nCell.InnerText = "2. " + _map.get("RPB", "Duties");
			...
			_nRow = _nTable.AppendChild(createRow());
			_nCell = _nRow.AppendChild(createCell());
			_nCell.InnerText = _map.get("RPB", "staffmember");
			_nCell = _nRow.AppendChild(createCell());
			_nCell.InnerText = _map.get("RPB", "datevisa");

			_nRow = _nTable.AppendChild(createRow());
			_nCell = _nRow.AppendChild(createCell());
			_nCell.InnerText = _map.get("RPB", "directchief");
			_nCell = _nRow.AppendChild(createCell());
			_nCell.InnerText = _map.get("RPB", "datevisa");

			_nRow = _nTable.AppendChild(createRow());
			_nCell = _nRow.AppendChild(createCell());
			_nCell.InnerText = _map.get("RPB", "nextchief");
			_nCell = _nRow.AppendChild(createCell());
			_nCell.InnerText = _map.get("RPB", "datevisa");

			_nRow = _nTable.AppendChild(createRow());
			_nCell = _nRow.AppendChild(createCell());
			_nCell.InnerText = _map.get("RPB", "humanresources");
			_nCell = _nRow.AppendChild(createCell());
			_nCell.InnerText = _map.get("RPB", "datevisa");
			...
			_nCell = _nRow.AppendChild(createCell());
			_nCell.Attributes.Append(createClassAttribute("detailValue"));
			_nCell.InnerText = _map.get("RPB", "printDate");
            ...
            _nCell.Attributes.Append(createClassAttribute("detailValue"));
            _nCell.Attributes.Append(createAttribute("colspan", "2"));
            _nCell.InnerText = _map.get("RPB", "remark");
        }
