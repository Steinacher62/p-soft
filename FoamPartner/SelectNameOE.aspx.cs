    ...
    public partial class SelectNameOE : System.Web.UI.Page
    {
        ...
        protected void cmdOk_Click(object sender, EventArgs e)
        {
            ...
            if (lstOE.SelectedIndex > 0)
            {
                ...
                //get persons in OEs
                DataTable persons = db.getDataTable("SELECT PersonID FROM Rep_Rating WHERE OrgentityID IN (" + oeIds + ")");
            ...
            {
                //person
                personIds = lstPerson.SelectedValue;
            }

            if (personIds != "" && personIds != "-1")
            {
                //redirect to report
                string person_enc = Global.EncodeTo64(personIds);
                Response.Redirect(Global.Config.baseURL.ToString() + "/Report//CrystalReportViewer.aspx?alias=LeistungsbewertungReisgies&param0=" + person_enc);
            }
            else
            {
