...
namespace ch.appl.psoft.MbO
{
    ...
    {
        private ch.appl.psoft.MbO.Controls.CopyListView _list;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            _list = (ch.appl.psoft.MbO.Controls.CopyListView)this.LoadPSOFTControl(ch.appl.psoft.MbO.Controls.CopyListView.Path, "_list");
