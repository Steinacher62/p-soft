...
namespace ch.appl.psoft.MbO
{
    public partial class CopyObjectiveToOE : System.Web.UI.Page
    {
        ...
        protected void cmdOk_Click(object sender, EventArgs e)
        {
            ...
            string templateSQL = "INSERT INTO OBJECTIVE (TITLE, PERSON_ID, DESCRIPTION, OBJECTIVE_TURN_ID, MEASUREMENT_TYPE_ID, CURRENTVALUE, VALUEIMPLICIT, TARGETVALUE, STARTDATE, DATEOFREACHING, CURRENTDATE, ARGUMENT, BSC, STATE, STATEDATE, TYP, FLAG, ACTIONNEED, MEASUREKRIT) SELECT "
                               + "TITLE, '%personID%' AS PERSON_ID, DESCRIPTION, '" + turnId + "' AS OBJECTIVE_TURN_ID, MEASUREMENT_TYPE_ID, CURRENTVALUE, VALUEIMPLICIT, TARGETVALUE, STARTDATE, DATEOFREACHING, CURRENTDATE, ARGUMENT, BSC, STATE, STATEDATE, TYP, FLAG, ACTIONNEED, MEASUREKRIT "
