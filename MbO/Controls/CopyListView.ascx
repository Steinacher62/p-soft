<%@ Control Language="c#" AutoEventWireup="True" Codebehind="CopyListView.ascx.cs" Inherits="ch.appl.psoft.MbO.Controls.CopyListView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
