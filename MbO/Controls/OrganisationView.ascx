<%@ Control Language="c#" AutoEventWireup="True" Codebehind="OrganisationView.ascx.cs" Inherits="ch.appl.psoft.MbO.Controls.OrganisationView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
