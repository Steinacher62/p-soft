<%@ Control Language="c#" AutoEventWireup="True" Codebehind="EditView.ascx.cs" Inherits="ch.appl.psoft.MbO.Controls.EditView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
