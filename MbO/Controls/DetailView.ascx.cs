namespace ch.appl.psoft.MbO.Controls
{
    ...
    public partial class DetailView : PSOFTDetailViewUserControl
    {
        ...
        {
            get { return Global.Config.baseURL + "/MbO/Controls/DetailView.ascx"; }
        }
        ...
        protected override void DoExecute()
        {
            ...
            try
            {
                ...
                table.Columns["argument_id"].ExtendedProperties["Visibility"] = DBColumn.Visibility.INVISIBLE;
                table.Columns["ORGENTITY_ID"].ExtendedProperties["Visibility"] = DBColumn.Visibility.INVISIBLE;
                table.Columns["MEASUREMENT_TYPE_ID"].ExtendedProperties["Visibility"] = DBColumn.Visibility.INVISIBLE;
                table.Columns["TARGETVALUE"].ExtendedProperties["Visibility"] = DBColumn.Visibility.INVISIBLE;
                ...
                if (DBColumn.GetValid(table.Rows[0]["PARENT_ID"], 0L) > 0) _deleteDetailURL += "/MbO/Detail.aspx?view=detail&id=" + table.Rows[0]["PARENT_ID"];
                else _deleteDetailURL += "/MbO/Search.aspx";
