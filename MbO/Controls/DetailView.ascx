<%@ Control Language="c#" AutoEventWireup="True" Codebehind="DetailView.ascx.cs" Inherits="ch.appl.psoft.MbO.Controls.DetailView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
