<%@ Control Language="c#" AutoEventWireup="True" Codebehind="ContactEditCtrl.ascx.cs" Inherits="ch.appl.psoft.Contact.Controls.ContactEditCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
