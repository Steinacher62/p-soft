<%@ Control Language="c#" AutoEventWireup="True" Codebehind="ContactList.ascx.cs" Inherits="ch.appl.psoft.Contact.Controls.ContactList" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
