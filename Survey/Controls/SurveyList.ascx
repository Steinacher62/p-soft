<%@ Control Language="c#" AutoEventWireup="True" Codebehind="SurveyList.ascx.cs" Inherits="ch.appl.psoft.Survey.Controls.SurveyList" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
