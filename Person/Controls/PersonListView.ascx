<%@ Control Language="c#" AutoEventWireup="True" Codebehind="PersonListView.ascx.cs" Inherits="ch.appl.psoft.Person.Controls.PersonListView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
