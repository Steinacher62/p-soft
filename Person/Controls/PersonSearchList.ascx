<%@ Control Language="c#" AutoEventWireup="True" Codebehind="PersonSearchList.ascx.cs" Inherits="ch.appl.psoft.Person.Controls.PersonSearchList" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
