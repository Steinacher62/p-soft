...
namespace ch.appl.psoft.crystalreports
{
    ...
    public class PersonWage0 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "ch.appl.psoft.crystalreports.PersonWage0.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPersonWage0 : Component, ICachedReport {
        
        public CachedPersonWage0() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PersonWage0 rpt = new PersonWage0();
            rpt.Site = this.Site;
            return rpt;
        }
