...
namespace ch.appl.psoft.Document
{
	...
	/// </summary>
	public partial class CheckIn : PsoftTreeViewPage
	{
        private const string PAGE_URL = "/Document/CheckIn.aspx";
		...
		protected void Page_Load(object sender, System.EventArgs e) 
		{
			...
			{
				// Setting parameters
                DokAblageCheckIn _dokAbl = (DokAblageCheckIn)this.LoadPSOFTControl(DokAblageCheckIn.Path, "_dokAbl");
				...
				try
				{
					switch (_dokAbl.TableName) 
					{
						case "DOCUMENT":
							...
							BreadcrumbCaption = _mapper.get("document", "checkIn");
							break;
					}
