<%@ Control Language="c#" AutoEventWireup="True" Codebehind="MailingListList.ascx.cs" Inherits="ch.appl.psoft.Document.Controls.MailingListList" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
