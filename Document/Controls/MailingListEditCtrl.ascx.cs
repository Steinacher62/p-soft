namespace ch.appl.psoft.Document.Controls
{
    ...
    public partial class MailingListEditCtrl : PSOFTInputViewUserControl
	{   
		...
		{
			get {return Global.Config.baseURL + "/Document/Controls/MailingListEditCtrl.ascx";}
		}
		...
		protected override void DoExecute()
		{
			...
			try 
			{
				...
				_table = _db.getDataTableExt("select * from EXCHANGE_FOLDER where ID=" + XID, "EXCHANGE_FOLDER");
