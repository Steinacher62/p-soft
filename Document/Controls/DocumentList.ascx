<%@ Control Language="c#" AutoEventWireup="True" Codebehind="DocumentList.ascx.cs" Inherits="ch.appl.psoft.Document.Controls.DocumentList" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
