<%@ Control Language="c#" AutoEventWireup="True" Codebehind="DokAblageCreate.ascx.cs" Inherits="ch.appl.psoft.Document.Controls.DokAblageCreate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
	...
	<tr>
		<td valign="top">
			<table border="0" cellSpacing="0" cellPadding="2">
				<tr>
					<td>
						<asp:table id="addTab" runat="server" CssClass="InputMask" BorderWidth="0"></asp:table>
					</td>
				</tr>
				<tr>
					<td>
