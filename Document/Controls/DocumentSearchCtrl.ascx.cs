namespace ch.appl.psoft.Document.Controls
{
    ...
    public partial class DocumentSearchCtrl : PSOFTSearchUserControl {
        ...
        public static string Path {
            get {return Global.Config.baseURL + "/Document/Controls/DocumentSearchCtrl.ascx";}
        }
        ...
        protected override void DoExecute() {
            ...
            try {
                ...
                _db.connect();
                _table = _db.getDataTableExt("select * from DOCUMENTV where ID=-1", "DOCUMENTV");
