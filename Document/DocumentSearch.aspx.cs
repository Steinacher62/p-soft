...
{
    public partial class DocumentSearch : PsoftTreeViewPage {

        private const string PAGE_URL = "/Document/DocumentSearch.aspx";
        ...
        private DocumentSearchCtrl _dSearch;
        private DocumentList _dList;
        ...
        protected void Page_Load(object sender, System.EventArgs e) {
            ...
            BreadcrumbCaption = _mapper.get("document","search");
            ...
            _dSearch = (DocumentSearchCtrl) LoadPSOFTControl(DocumentSearchCtrl.Path, "_dS");
            ...
            _dList = (DocumentList) LoadPSOFTControl(DocumentList.Path, "_dL");
            _dList.Mode = DocumentList.MODE_SEARCHRESULT;
            _dList.OrderColumn = _orderColumn;
            _dList.OrderDir = _orderDir;
            _dList.Visible = false;
            _dList.DetailURL = psoft.Document.Detail.GetURL("xID","%ID", "table","DOCUMENT");
