...
{
    /// <summary>
    /// Summary description for PrintXSkills.
    /// </summary>
    public partial class PrintXSkills : System.Web.UI.Page {
        ...
        protected void Page_Load(object sender, System.EventArgs e) {
            ...
            try {
                ...
                XSkillsReport report = new XSkillsReport(Session, imageDirectory);

                if (_jobID > 0) {
                    fileName += "job" + _jobID;
                }
                if (_personID > 0) {
                    fileName += "person" + _personID;
                }
                report.createReport(_jobID, _personID);
