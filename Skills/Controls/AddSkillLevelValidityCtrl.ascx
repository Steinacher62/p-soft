<%@ Control Language="c#" AutoEventWireup="True" Codebehind="AddSkillLevelValidityCtrl.ascx.cs" Inherits="ch.appl.psoft.Skills.Controls.AddSkillLevelValidityCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
