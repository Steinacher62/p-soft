<%@ Control Language="c#" AutoEventWireup="True" Codebehind="AppraisalDetailCtrl.ascx.cs" Inherits="ch.appl.psoft.Skills.Controls.AppraisalDetailCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
