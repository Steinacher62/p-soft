<%@ Control Language="c#" AutoEventWireup="True" Codebehind="EditSkillHandsFreeCtrl.ascx.cs" Inherits="ch.appl.psoft.Skills.Controls.EditSkillHandsFreeCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
