<%@ Control Language="c#" AutoEventWireup="True" Codebehind="EditSkillLevelValidityCtrl.ascx.cs" Inherits="ch.appl.psoft.Skills.Controls.EditSkillLevelValidityCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
