<%@ Control Language="c#" AutoEventWireup="True" Codebehind="MainControl.ascx.cs" Inherits="ch.appl.psoft.Lohn.Controls.MainControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
