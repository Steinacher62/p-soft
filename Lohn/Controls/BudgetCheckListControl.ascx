<%@ Control Language="c#" AutoEventWireup="True" Codebehind="BudgetCheckListControl.ascx.cs" Inherits="ch.appl.psoft.Lohn.Controls.BudgetCheckListControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
