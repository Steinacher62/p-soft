<%@ Control Language="c#" AutoEventWireup="True" Codebehind="BudgetCheckControl.ascx.cs" Inherits="ch.appl.psoft.Lohn.Controls.BudgetCheckControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
