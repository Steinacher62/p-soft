...
function ig_initShared()
{
	...
	if (this.IsIE)
	{
		var v = this.AgentName.indexOf("msie ") + 5;
		if (v < 5)
			v = this.AgentName.indexOf("rv:") + 3;
		this.MajorIEVersion = parseInt(this.AgentName.substr(v));
		...
		this.IsIE10Plus = this.MajorIEVersion >= 10;
		this.IsIE11Plus = this.MajorIEVersion >= 11;
	}
