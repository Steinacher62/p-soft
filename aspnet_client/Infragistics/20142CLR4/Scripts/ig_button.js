...
function ig_WebButton(id,prop,evs)
{
	...
	this.setEnabled = function (v) { if (this._disTD) this._elems[5].disabled = !v; this._elems[5].style.cursor = "pointer"; if(!v)this._key=this._fcs=null;this.update("Enabled",!(this._elems[0].disabled=!v));this.paint(true);}
	...
	this.doMouse=function(e,a,s)
	{
		...
		var b=e.button,ie=ig_shared.IsIE&&!ig_shared.IsIE11Plus;
		if((a>2&&ie&&b!=1)||(a>2&&!ie&&b))return;
