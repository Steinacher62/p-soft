<%@ Control Language="c#" AutoEventWireup="True" Codebehind="TrainingCatalogTreeCtrl.ascx.cs" Inherits="ch.appl.psoft.Training.Controls.TrainingCatalogTreeCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
