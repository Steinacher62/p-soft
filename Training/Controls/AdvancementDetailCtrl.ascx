<%@ Control Language="c#" AutoEventWireup="True" Codebehind="AdvancementDetailCtrl.ascx.cs" Inherits="ch.appl.psoft.Training.Controls.AdvancementDetailCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
