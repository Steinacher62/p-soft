<%@ Control Language="c#" AutoEventWireup="True" Codebehind="AdvancementEditCtrl.ascx.cs" Inherits="ch.appl.psoft.Training.Controls.AdvancementEditCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
