<%@ Control Language="c#" AutoEventWireup="True" Codebehind="KnowledgeSearchCtrl.ascx.cs" Inherits="ch.appl.psoft.Knowledge.Controls.KnowledgeSearchCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
