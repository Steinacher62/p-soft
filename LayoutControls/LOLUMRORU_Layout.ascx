<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LOLUMRORU_Layout.ascx.cs" Inherits="ch.appl.psoft.LayoutControls.LOLUMRORU_Layout" %>
<div class="LOLUMRORUContent">
