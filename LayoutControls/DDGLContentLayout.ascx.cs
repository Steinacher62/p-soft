namespace ch.appl.psoft.LayoutControls
{
    ...
    /// <summary>
    ///		This is a Detail-Detail-Group-Links layout page
    ///		-------------------------------
    ///		| DETAIL | DETAIL |           |
    ///		| LEFT   | RIGHT  |           |
    ///		|        |        |           |
    ...
    ///		-------------------------------
    /// </summary>
    public partial class DDGLContentLayout : ContentLayoutControl {
        ...
        /// </summary>
        public const string DETAIL_LEFT  = "DETAIL_LEFT";
        public const string DETAIL_RIGHT = "DETAIL_RIGHT";
        ...
        public static string Path {
            get {return Global.Config.baseURL + "/LayoutControls/DDGLContentLayout.ascx";}
        }

		#region Properities
        public PSOFTUserControl DetailLeftControl {
            set {SetContentControl(DETAIL_LEFT, value);}
        }

        public PSOFTUserControl DetailRightControl {
            set {SetContentControl(DETAIL_RIGHT, value);}
        }
        ...
        public Unit DetailLeftWidth {
            get{ return detailLeftCell.Width; }
            set{ detailLeftCell.Width = value; }
        }

        public Unit DetailRightWidth {
            get{ return detailRightCell.Width; }
            set{ detailRightCell.Width = value; }
        }
        ...
        public bool GroupWide{
            ...
            set{
                ...
                groupCell.ColumnSpan = value? 4 : 2;
            }
        }
        ...
        protected override Control DoGetContentPlace(string contentPlaceName) {
            ...
            if (contentPlaceName == DETAIL_LEFT) {
                return detailLeftCellDiv;
            }
            else if (contentPlaceName == DETAIL_RIGHT) {
                return detailRightCellDiv;
            }
