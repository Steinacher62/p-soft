<%@ Control Language="c#" AutoEventWireup="True" Codebehind="PerformanceRatingSelectPeriod.ascx.cs" Inherits="ch.appl.psoft.Performance.Controls.PerformanceRatingSelectPeriod" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
