<%@ Control Language="c#" AutoEventWireup="True" Codebehind="PerformanceRatingSearch.ascx.cs" Inherits="ch.appl.psoft.Performance.Controls.PerformanceRatingSearch" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
