<%@ Control Language="c#" AutoEventWireup="True" Codebehind="GlobalPerformanceSelectDate.ascx.cs" Inherits="ch.appl.psoft.Performance.Controls.GlobalPerformanceSelectDate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
