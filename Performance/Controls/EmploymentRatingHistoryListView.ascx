<%@ Control Language="c#" AutoEventWireup="True" Codebehind="EmploymentRatingHistoryListView.ascx.cs" Inherits="ch.appl.psoft.Performance.Controls.EmploymentRatingHistoryListView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
