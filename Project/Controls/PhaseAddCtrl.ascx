<%@ Control Language="c#" AutoEventWireup="True" Codebehind="PhaseAddCtrl.ascx.cs" Inherits="ch.appl.psoft.Project.Controls.PhaseAddCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
