<%@ Control Language="c#" AutoEventWireup="True" Codebehind="PhaseEditCtrl.ascx.cs" Inherits="ch.appl.psoft.Project.Controls.PhaseEditCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
