<%@ Control Language="c#" AutoEventWireup="True" Codebehind="ProjectAddCtrl.ascx.cs" Inherits="ch.appl.psoft.Project.Controls.ProjectAddCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
