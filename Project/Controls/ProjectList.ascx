<%@ Control Language="c#" AutoEventWireup="True" Codebehind="ProjectList.ascx.cs" Inherits="ch.appl.psoft.Project.Controls.ProjectList" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script  type='text/javascript'>
    var deleteURL = "<%=PostDeleteURL%>";

    function deleteRowConfirm(rowId,dbId)
    {
        wsDeleteRowConfirm(this, deleteURL, deleteConfirmMessage, "PROJECT", rowId, dbId)
    }
</script>
<asp:Table Runat="server" id="Table1" Height="100%">
	<asp:TableRow>
		...
		<asp:TableCell HorizontalAlign=Right>
			<asp:checkbox id="CBShowInactive" runat="server" AutoPostBack="True"></asp:checkbox>
		</asp:TableCell>
	</asp:TableRow>
	<asp:TableRow>
