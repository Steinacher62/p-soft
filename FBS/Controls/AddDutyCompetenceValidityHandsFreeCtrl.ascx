<%@ Control Language="c#" AutoEventWireup="True" Codebehind="AddDutyCompetenceValidityHandsFreeCtrl.ascx.cs" Inherits="ch.appl.psoft.FBS.Controls.AddDutyCompetenceValidityHandsFreeCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
