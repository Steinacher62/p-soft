<%@ Control Language="c#" AutoEventWireup="True" Codebehind="AddDutyCompetenceValidityCtrl.ascx.cs" Inherits="ch.appl.psoft.FBS.Controls.AddDutyCompetenceValidityCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
