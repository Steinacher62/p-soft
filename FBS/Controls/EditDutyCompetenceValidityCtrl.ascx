<%@ Control Language="c#" AutoEventWireup="True" Codebehind="EditDutyCompetenceValidityCtrl.ascx.cs" Inherits="ch.appl.psoft.FBS.Controls.EditDutyCompetenceValidityCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
