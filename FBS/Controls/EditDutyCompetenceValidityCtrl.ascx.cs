namespace ch.appl.psoft.FBS.Controls
{
    ...
    /// <summary>
    ///		Summary description for EditDutyCompetenceValidityCtrl.
    /// </summary>
    public partial class EditDutyCompetenceValidityCtrl : PSOFTInputViewUserControl
	{
		...
		{
			get {return Global.Config.baseURL + "/FBS/Controls/EditDutyCompetenceValidityCtrl.ascx";}
		}
