<%@ Control Language="c#" AutoEventWireup="True" Codebehind="DutyCatalogTreeCtrl.ascx.cs" Inherits="ch.appl.psoft.FBS.Controls.DutyCatalogTreeCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<asp:Table ID="treeTab" Runat="server" CssClass="Tree" Width="100%">
    <asp:TableRow>
        <asp:TableCell>
            <asp:label id="DutyGroupTreeTitle" runat="server" CssClass="section_title"></asp:label>
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow>
