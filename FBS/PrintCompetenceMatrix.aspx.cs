...
{
    /// <summary>
    /// Summary description for PrintCompetenceMatrix.
    /// </summary>
    public partial class PrintCompetenceMatrix : PsoftContentPage 
    {
        public const string PAGE_URL = "/FBS/PrintCompetenceMatrix.aspx";
        ...
        protected void Page_Load(object sender, System.EventArgs e) 
        {
            ...
            PsoftPageLayout.PageTitle = _mapper.get("fbs","competenceMatrixTitle"); 
            ...
            search.ReportType = OrganisationUnitSearchCtrl.ReportTypeEnum.COMPETENCE;
