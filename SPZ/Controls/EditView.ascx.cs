namespace ch.appl.psoft.SPZ.Controls
{
    ...
    public partial class EditView : PSOFTInputViewUserControl
    {
        ...
        {
            get { return Global.Config.baseURL + "/SPZ/Controls/EditView.ascx"; }
        }
        ...
        private void redirect()
        {
            if (_backURL == "")
            {
                _backURL = Global.Config.baseURL + "/SPZ/Detail.aspx?view=detail&context=" + _context + "&contextId=" + _contextId + "&id=" + _id;
            }
                    ...
                    else if (_action == "add" || _action == "copy")
                    {
                        ...
                        switch (_typ)
                        {
                            ...
                            case Objective.PERSON_TYP:
                                ...
                                //if (_backURL == "") _backURL = Global.Config.baseURL + "/SPZ/Detail.aspx?context=PERSON&contextId="+_contextId+"&id="+_id;
                                break;
                            case Objective.PROJECT_TYP:
                                base.extendSql(sql, _table, "parent_id", null);
                                base.extendSql(sql, _table, "root_id", null);
                                base.extendSql(sql, _table, "project_id", _contextId);
                                //if (_backURL == "") _backURL = Global.Config.baseURL + "/SPZ/Detail.aspx?context=PROJECT&contextId="+_contextId+"&id="+_id;
                                break;
                            default:
                                return;
                        }
