<%@ Control Language="c#" AutoEventWireup="True" Codebehind="DetailView.ascx.cs" Inherits="ch.appl.psoft.SPZ.Controls.DetailView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
