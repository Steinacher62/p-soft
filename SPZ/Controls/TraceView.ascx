<%@ Control Language="c#" AutoEventWireup="True" Codebehind="TraceView.ascx.cs" Inherits="ch.appl.psoft.SPZ.Controls.TraceView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
