<%@ Control Language="c#" AutoEventWireup="True" Codebehind="ListView.ascx.cs" Inherits="ch.appl.psoft.SPZ.Controls.ListView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
