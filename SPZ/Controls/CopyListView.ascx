<%@ Control Language="c#" AutoEventWireup="True" Codebehind="CopyListView.ascx.cs" Inherits="ch.appl.psoft.SPZ.Controls.CopyListView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
