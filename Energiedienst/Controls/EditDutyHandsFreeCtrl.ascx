<%@ Control Language="c#" AutoEventWireup="True" Codebehind="EditDutyHandsFreeCtrl.ascx.cs" Inherits="ch.appl.psoft.Energiedienst.Controls.EditDutyHandsFreeCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
