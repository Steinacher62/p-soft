<%@ Control Language="c#" AutoEventWireup="True" Codebehind="EmploymentRatingItemEditView.ascx.cs" Inherits="ch.appl.psoft.Energiedienst.Controls.EmploymentRatingItemEditView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
