<%@ Control Language="c#" AutoEventWireup="True" Codebehind="AdvancementList.ascx.cs" Inherits="ch.appl.psoft.Energiedienst.Controls.AdvancementList" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
