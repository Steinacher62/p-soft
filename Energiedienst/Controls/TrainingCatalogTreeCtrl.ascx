<%@ Control Language="c#" AutoEventWireup="True" Codebehind="TrainingCatalogTreeCtrl.ascx.cs" Inherits="ch.appl.psoft.Energiedienst.Controls.TrainingCatalogTreeCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<asp:Table ID="treeTab" Runat="server" CssClass="Tree" Width="100%">
    <asp:TableRow>
        <asp:TableCell>
            <asp:label id="TrainingGroupTreeTitle" runat="server" CssClass="section_title"></asp:label>
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow>
