...
namespace ch.appl.psoft.Energiedienst
{
    ...
    public partial class JobDescription : PsoftDetailPage
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            JobDescriptionCtrl jdCtrl = (JobDescriptionCtrl)this.LoadPSOFTControl(Global.Config.baseURL +"/Energiedienst/Controls/JobDescriptionCtrl.ascx", "_jobDesc");
                ...
                if (jdCtrl.JobID > 0)
                {
                    if (db.hasRowAuthorisation(DBData.AUTHORISATION.READ, "JOB", jdCtrl.JobID, DBData.APPLICATION_RIGHT.JOB_DESCRIPTION, true, true))
                    {
                        string specialDirectory = "";
                            ...
                            //    "onClick",
                            //    "javascript: window.open('" + specialDirectory + "PrintJobDescription.aspx?jobID=" + jdCtrl.JobID + "' ,'_self');"
                            //    );
                      
                        } 
                        PsoftPageLayout.ButtonPrintVisible = false;
